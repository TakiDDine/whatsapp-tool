...
use \App\Models\Post;
use \App\Helpers\Cash;
use \App\Helpers\Listing;
use \App\Helpers\Revenue;
...
class Starter
{
    ...
    public function registerTwigView($container)
    {
        ...
        $container['view'] = function ($c) {
            ...
            $view->getEnvironment()->addGlobal('session', $_SESSION['auth-logged'] ?? null);
            $view->getEnvironment()->addGlobal('total_cart', isset($_SESSION['product']) ? count($_SESSION['product']) : 0);
